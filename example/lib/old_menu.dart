...
class OldMenu<T> extends StatefulWidget {
  const OldMenu({
    super.key,
    required this.items,
    required this.value,
  ...
  @override
  State<OldMenu<T>> createState() => _MenuState<T>();
}

class _MenuState<T> extends State<OldMenu<T>> {
  ...
  @override
  void didUpdateWidget(OldMenu<T> oldWidget) {
