...
class DataInspector extends StatelessWidget {
  ...
  int _getInt16() {
    ...
    return byteData.getInt16(0, endianness == Endianness.little ? Endian.little : Endian.big);
  }
  ...
  int _getUInt16() {
    ...
    final bytes = data.sublist(offset, offset + 2);
    final byteData = ByteData.sublistView(bytes);
    return byteData.getUint16(0, endianness == Endianness.little ? Endian.little : Endian.big);
  }
  ...
  int _getInt32() {
    ...
    final byteData = ByteData.sublistView(bytes);
    return byteData.getInt32(0, endianness == Endianness.little ? Endian.little : Endian.big);
  }
  ...
  int _getUInt32() {
    ...
    final bytes = data.sublist(offset, offset + 4);
    final byteData = ByteData.sublistView(bytes);
    return byteData.getUint32(0, endianness == Endianness.little ? Endian.little : Endian.big);
  }
  ...
  int _getInt64() {
    ...
    final byteData = ByteData.sublistView(bytes);
    return byteData.getInt64(0, endianness == Endianness.little ? Endian.little : Endian.big);
  }
  ...
  int _getUInt64() {
    ...
    final bytes = data.sublist(offset, offset + 8);
    final byteData = ByteData.sublistView(bytes);
    return byteData.getUint64(0, endianness == Endianness.little ? Endian.little : Endian.big);
  }
  ...
  double _getFloat32() {
    ...
    final bytes = data.sublist(offset, offset + 4);
    final byteData = ByteData.sublistView(bytes);
    return byteData.getFloat32(0, endianness == Endianness.little ? Endian.little : Endian.big);
  }
  ...
  double _getFloat64() {
    ...
    final bytes = data.sublist(offset, offset + 8);
    final byteData = ByteData.sublistView(bytes);
    return byteData.getFloat64(0, endianness == Endianness.little ? Endian.little : Endian.big);
  }

  String _getBinary() {
    final selected = data.sublist(offset, math.min(offset + length, data.length));
  ...
  String _getAscii() {
    final selected = data.sublist(offset, math.min(offset + length, data.length));
    return selected.map((b) => (b >= 32 && b <= 126) ? String.fromCharCode(b) : '.').join();
  }
